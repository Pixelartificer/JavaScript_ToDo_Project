document.addEventListener("DOMContentLoaded", () => {
  ...
  modalBox.className =
    "relative w-full max-w-md overflow-hidden rounded-3xl border border-white/70 bg-white/80 shadow-2xl backdrop-blur-2xl";
  ...
  emojiBtn.addEventListener("click", () => {
    ...
    categoryBar.className =
      "mb-4 flex gap-2 overflow-x-auto pb-2 scrollbar-hide";

    // Emoji grid
    const emojiGrid = document.createElement("div");

    emojiGrid.className =
      "grid max-h-[320px] grid-cols-7 gap-1 overflow-y-auto rounded-2xl bg-white/50 p-2";
  ...
  locationBtn.addEventListener("click", () => {
    ...
    locationInput.className =
      "w-full rounded-2xl border border-slate-200 bg-white/70 px-4 py-3 outline-none transition focus:border-emerald-400 focus:ring-4 focus:ring-emerald-100";

    wrapper.appendChild(locationInput);

    const currentLocationBtn = createElement(
      "button",
      "mt-3 flex w-full items-center gap-3 rounded-2xl border border-emerald-100 bg-emerald-50/80 p-4 text-left transition hover:bg-emerald-100",
      "",
    );

    const locationIcon = createElement(
      "span",
      "flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-emerald-500 text-white shadow-lg",
      "📍",
    );

    const locationTextBox = document.createElement("div");

    const locationTitle = createElement(
      "p",
      "font-semibold text-emerald-800",
      "Use my current location",
    );

    const locationSubtitle = createElement(
      "p",
    ...
    const addBtn = createElement(
      "button",
      "flex-1 rounded-2xl bg-gradient-to-r from-emerald-500 to-teal-500 py-3 font-semibold text-white shadow-lg shadow-emerald-200 transition hover:-translate-y-0.5",
      "Add Location",
    );
  ...
  linkBtn.addEventListener("click", () => {
    ...
    const subtitle = createElement(
      "p",
      "text-xs text-slate-500",
      "Share a website with your community",
    );
    ...
    urlInput.className =
      "w-full rounded-2xl border border-slate-200 bg-white/70 px-4 py-3 outline-none transition focus:border-orange-400 focus:ring-4 focus:ring-orange-100";
    ...
    titleInput.className =
      "mt-3 w-full rounded-2xl border border-slate-200 bg-white/70 px-4 py-3 outline-none transition focus:border-orange-400 focus:ring-4 focus:ring-orange-100";
    ...
    preview.className =
      "mt-4 hidden rounded-2xl border border-orange-100 bg-orange-50/70 p-4";
    ...
    const previewUrl = createElement(
      "p",
      "mt-1 break-all text-xs text-orange-600",
    );
    ...
    const addBtn = createElement(
      "button",
      "flex-1 rounded-2xl bg-gradient-to-r from-orange-500 to-amber-500 py-3 font-semibold text-white shadow-lg shadow-orange-200 transition hover:-translate-y-0.5",
      "Add Link",
    );
  ...
  function renderPosts() {
    ...
    posts.forEach((post) => {
      ...
      const avatar = createElement(
        "div",
        "flex h-11 w-11 items-center justify-center rounded-full bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 font-bold text-white shadow-lg",
      ...
      const editBtn = createElement(
        "button",
        "flex w-full items-center gap-2 rounded-xl px-3 py-2 text-left text-sm text-slate-700 hover:bg-indigo-50",
        "✏️ Edit",
      );
  ...
  function editPost(id) {
    ...
    editInput.className =
      "w-full resize-none rounded-2xl border border-slate-200 bg-white/70 px-4 py-3 outline-none focus:border-indigo-400 focus:ring-4 focus:ring-indigo-100";
    ...
    const saveBtn = createElement(
      "button",
      "flex-1 rounded-2xl bg-gradient-to-r from-indigo-500 to-purple-600 py-3 font-semibold text-white shadow-lg shadow-indigo-200",
      "Save Changes",
    );
  ...
  function openCommentModal(post) {
    ...
    commentInput.className =
      "mt-4 w-full resize-none rounded-2xl border border-slate-200 bg-white/70 px-4 py-3 outline-none focus:border-purple-400 focus:ring-4 focus:ring-purple-100";
    ...
    const commentBtn = createElement(
      "button",
      "flex-1 rounded-2xl bg-gradient-to-r from-purple-500 to-pink-500 py-3 font-semibold text-white shadow-lg",
      "Comment",
    );
